...
export const RBAC_PERMISSIONS: PermissionDefinition[] = [
  ...
  { key: 'submissions.view', label: 'View submissions', description: 'View showings and contact messages.', group: 'Submissions' },
...
export const SYSTEM_ROLE_TEMPLATES: RoleTemplate[] = [
  ...
  },
  {
    ...
    description: 'Can manage property listings and respond to showing submissions.',
    isSystem: true,
    permissionKeys: [
      'dashboard.view',
      'properties.view',
  ...
  {
    name: 'Support',
    description: 'Can review and update contact and showing submissions.',
    isSystem: true,
    permissionKeys: [
      'dashboard.view',
      'submissions.view',
...
export const DASHBOARD_NAV_ITEMS: DashboardNavItem[] = [
  ...
  { section: 'Submissions', to: '/dashboard/showings', label: 'Showing requests', anyPermissions: ['submissions.view'] },
  { section: 'Submissions', to: '/dashboard/contact-messages', label: 'Contact messages', anyPermissions: ['submissions.view'] },
...
const DASHBOARD_ROUTE_REQUIREMENTS: Array<{ prefix: string; anyPermissions: string[] }> = [
  ...
  { prefix: '/dashboard/showings', anyPermissions: ['submissions.view'] },
  { prefix: '/dashboard/contact-messages', anyPermissions: ['submissions.view'] },
